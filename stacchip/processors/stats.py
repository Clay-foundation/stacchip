...
from stacchip.processors.prechip import (CUBESIZE, LINZ_BANDS, LS_BANDS,
                                         NAIP_BANDS, S1_BANDS, S2_BANDS)
...
def get_stats_keys(key):
    ...
    pixel_count = CUBESIZE * 256 * 256
    pixel_sum = np.sum(data, axis=(1, 2, 3))
    pixel_sqr = np.sum(np.power(data, 2), axis=(1, 2, 3))
...
def process():
    ...
    for page in page_iterator:
        ...
        for key in keys:
            ...
            px0, px1, px2 = get_stats_keys(key)
